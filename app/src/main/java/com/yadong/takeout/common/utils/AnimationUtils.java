...
public class AnimationUtils {
    ...
    public static AnimationSet getShowMinusAnimation() {
        ...
        TranslateAnimation translate = new TranslateAnimation(Animation.RELATIVE_TO_SELF, 10,
    ...
    public static AnimationSet getHideMinusAnimation() {
        ...
        TranslateAnimation translate = new TranslateAnimation(Animation.RELATIVE_TO_SELF,
                0, Animation.RELATIVE_TO_SELF, 20, Animation.RELATIVE_TO_SELF, 0, Animation.RELATIVE_TO_SELF, 0);
        RotateAnimation rotate = new RotateAnimation(0, 360, Animation.RELATIVE_TO_SELF, 0.5f,
                Animation.RELATIVE_TO_SELF, 0.5f);
    ...
    public static Animation getAddAnimation(int[] destLocation, int[] srcLocation) {
        AnimationSet set = new AnimationSet(false);
        TranslateAnimation translateX = new TranslateAnimation(Animation.ABSOLUTE, 0,
